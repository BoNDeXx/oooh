...
public class SyrodutBlock extends ZweihanderTestModElements.ModElement {
	@ObjectHolder("zweihander_test:syrodut")
	public static final Block block = null;
	@ObjectHolder("zweihander_test:syrodut")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public SyrodutBlock(ZweihanderTestModElements instance) {
		super(instance, 3);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("syrodut"));
		}
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.CLAY).sound(SoundType.NETHER_BRICK).hardnessAndResistance(2f, 10f).setLightLevel(s -> 0).notSolid()
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("syrodut");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Rennofen");
		}
