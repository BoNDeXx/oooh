...
import net.mcreator.zweihandertest.gui.StoneCraftGuiWindow;
...
public class PebbleItem extends ZweihanderTestModElements.ModElement {
	@ObjectHolder("zweihander_test:pebble")
	public static final Item block = null;

	public PebbleItem(ZweihanderTestModElements instance) {
		super(instance, 5);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof StoneCraftGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Pebble");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new StoneCraftGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
