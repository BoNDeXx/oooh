...
public class ChugunokItem extends ZweihanderTestModElements.ModElement {
	@ObjectHolder("zweihander_test:chugunok")
	public static final Item block = null;

	public ChugunokItem(ZweihanderTestModElements instance) {
		super(instance, 7);
	}
