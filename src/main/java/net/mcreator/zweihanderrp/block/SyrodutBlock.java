...
public class SyrodutBlock extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:syrodut")
	public static final Block block = null;
	@ObjectHolder("zweihanderrp:syrodut")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public SyrodutBlock(ZweihanderrpModElements instance) {
		super(instance, 3);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.SHULKER).sound(SoundType.NETHER_BRICK).hardnessAndResistance(2f, 10f).setLightLevel(s -> 0)
