...
public class RedtophelmItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:redtophelm_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:redtophelm_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:redtophelm_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:redtophelm_boots")
	public static final Item boots = null;

	public RedtophelmItem(ZweihanderrpModElements instance) {
		super(instance, 51);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("redtophelm_helmet"));
	}
