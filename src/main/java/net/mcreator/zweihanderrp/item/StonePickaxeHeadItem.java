...
public class StonePickaxeHeadItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:stone_pickaxe_head")
	public static final Item block = null;

	public StonePickaxeHeadItem(ZweihanderrpModElements instance) {
		super(instance, 22);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("stone_pickaxe_head");
		}
