...
public class KoifeItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:koife_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:koife_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:koife_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:koife_boots")
	public static final Item boots = null;

	public KoifeItem(ZweihanderrpModElements instance) {
		super(instance, 61);
	}
