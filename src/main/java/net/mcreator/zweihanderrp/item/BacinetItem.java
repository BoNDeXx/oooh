...
public class BacinetItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:bacinet_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:bacinet_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:bacinet_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:bacinet_boots")
	public static final Item boots = null;

	public BacinetItem(ZweihanderrpModElements instance) {
		super(instance, 44);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("bacinet_helmet"));
	}
