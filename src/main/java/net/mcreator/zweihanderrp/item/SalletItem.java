...
public class SalletItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:sallet_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:sallet_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:sallet_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:sallet_boots")
	public static final Item boots = null;

	public SalletItem(ZweihanderrpModElements instance) {
		super(instance, 46);
	}
