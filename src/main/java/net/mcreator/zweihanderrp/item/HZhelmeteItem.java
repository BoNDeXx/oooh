...
public class HZhelmeteItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:h_zhelmete_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:h_zhelmete_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:h_zhelmete_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:h_zhelmete_boots")
	public static final Item boots = null;

	public HZhelmeteItem(ZweihanderrpModElements instance) {
		super(instance, 48);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("h_zhelmete_helmet"));
	}
