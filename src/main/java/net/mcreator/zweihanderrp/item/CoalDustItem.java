...
public class CoalDustItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:coal_dust")
	public static final Item block = null;

	public CoalDustItem(ZweihanderrpModElements instance) {
		super(instance, 8);
	}
