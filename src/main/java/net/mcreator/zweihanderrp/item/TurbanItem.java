...
public class TurbanItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:turban_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:turban_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:turban_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:turban_boots")
	public static final Item boots = null;

	public TurbanItem(ZweihanderrpModElements instance) {
		super(instance, 77);
	}
