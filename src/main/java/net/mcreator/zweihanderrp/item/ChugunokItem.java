...
public class ChugunokItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:chugunok")
	public static final Item block = null;

	public ChugunokItem(ZweihanderrpModElements instance) {
		super(instance, 7);
	}
