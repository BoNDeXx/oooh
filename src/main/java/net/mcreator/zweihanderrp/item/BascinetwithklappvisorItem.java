...
public class BascinetwithklappvisorItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:bascinetwithklappvisor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:bascinetwithklappvisor_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:bascinetwithklappvisor_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:bascinetwithklappvisor_boots")
	public static final Item boots = null;

	public BascinetwithklappvisorItem(ZweihanderrpModElements instance) {
		super(instance, 47);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("bascinetwithklappvisor_helmet"));
	}
