...
public class BluedsalletItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:bluedsallet_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:bluedsallet_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:bluedsallet_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:bluedsallet_boots")
	public static final Item boots = null;

	public BluedsalletItem(ZweihanderrpModElements instance) {
		super(instance, 57);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("bluedsallet_helmet"));
	}
