...
public class BarbuteItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:barbute_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zweihanderrp:barbute_chestplate")
	public static final Item body = null;
	@ObjectHolder("zweihanderrp:barbute_leggings")
	public static final Item legs = null;
	@ObjectHolder("zweihanderrp:barbute_boots")
	public static final Item boots = null;

	public BarbuteItem(ZweihanderrpModElements instance) {
		super(instance, 45);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("barbute_helmet"));
	}
