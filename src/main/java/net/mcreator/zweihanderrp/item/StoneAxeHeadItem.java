...
public class StoneAxeHeadItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:stone_axe_head")
	public static final Item block = null;

	public StoneAxeHeadItem(ZweihanderrpModElements instance) {
		super(instance, 20);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("stone_axe_head");
		}
