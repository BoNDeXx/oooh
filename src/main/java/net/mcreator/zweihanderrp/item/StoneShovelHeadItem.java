...
public class StoneShovelHeadItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:stone_shovel_head")
	public static final Item block = null;

	public StoneShovelHeadItem(ZweihanderrpModElements instance) {
		super(instance, 19);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("stone_shovel_head");
		}
