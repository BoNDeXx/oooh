...
public class StoneHoeHeadItem extends ZweihanderrpModElements.ModElement {
	@ObjectHolder("zweihanderrp:stone_hoe_head")
	public static final Item block = null;

	public StoneHoeHeadItem(ZweihanderrpModElements instance) {
		super(instance, 21);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("stone_hoe_head");
		}
