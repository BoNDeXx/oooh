...
import net.mcreator.zweihanderrp.gui.StoneCraftGui;
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ZweihanderrpMod.LOGGER.warn("Failed to load dependency world for procedure LandRockOnBlockRightClickedcarve!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ZweihanderrpMod.LOGGER.warn("Failed to load dependency x for procedure LandRockOnBlockRightClickedcarve!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ZweihanderrpMod.LOGGER.warn("Failed to load dependency y for procedure LandRockOnBlockRightClickedcarve!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ZweihanderrpMod.LOGGER.warn("Failed to load dependency z for procedure LandRockOnBlockRightClickedcarve!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ZweihanderrpMod.LOGGER.warn("Failed to load dependency entity for procedure LandRockOnBlockRightClickedcarve!");
			return;
		}
