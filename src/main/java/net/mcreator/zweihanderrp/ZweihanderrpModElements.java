...
public class ZweihanderrpModElements {
	...
	public ZweihanderrpModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == ZweihanderrpModElements.ModElement.class)
						elements.add((ZweihanderrpModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(ZweihanderrpModElements.ModElement::initElements);
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		ZweihanderrpMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final ZweihanderrpModElements elements;
		protected final int sortid;

		public ModElement(ZweihanderrpModElements elements, int sortid) {
