...
public class RennOfenGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RennOfenGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
